...
extern long objstore_write(int objid, const char *, int, struct objfs_state *,off_t block_offset);
extern long objstore_read(int objid, char *, int, struct objfs_state *,off_t block_offset);
